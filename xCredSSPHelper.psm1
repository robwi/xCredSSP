...
Import-LocalizedData LocalizedData -filename xCredSSP.strings.psd1 -ErrorAction SilentlyContinue
Import-LocalizedData USLocalizedData -filename xCredSSP.strings.psd1 -UICulture en-US -ErrorAction SilentlyContinue
